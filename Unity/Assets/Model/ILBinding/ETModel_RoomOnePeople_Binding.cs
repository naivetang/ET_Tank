...
{
    unsafe class ETModel_RoomOnePeople_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ETModel.RoomOnePeople);
            args = new Type[]{};
        ...
        static StackObject* get_Level_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ETModel.RoomOnePeople instance_of_this_method = (ETModel.RoomOnePeople)typeof(ETModel.RoomOnePeople).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
