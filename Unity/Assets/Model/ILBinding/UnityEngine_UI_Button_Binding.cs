...
{
    unsafe class UnityEngine_UI_Button_Binding
    {
        ...
        static StackObject* get_onClick_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
