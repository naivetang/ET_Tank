...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_UIFactoryAttribute_Binding
    {
        ...
        static StackObject* get_Type_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ETModel.UIFactoryAttribute instance_of_this_method = (ETModel.UIFactoryAttribute)typeof(ETModel.UIFactoryAttribute).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
