...
namespace ILRuntime.Runtime.Generated
{
    class CLRBindings
    {
        ...
        public static void Initialize(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            ETModel_C2G_CreateRoom_Binding.Register(app);
            ...
            ETModel_G2C_Rooms_Binding.Register(app);
            Google_Protobuf_Collections_RepeatedField_1_RoomSimpleInfo_Binding.Register(app);
            System_Collections_Generic_IEnumerator_1_RoomSimpleInfo_Binding.Register(app);
            System_Collections_Generic_List_1_RoomSimpleInfo_Binding.Register(app);
            FairyGUI_GList_Binding.Register(app);
            ETModel_RoomSimpleInfo_Binding.Register(app);
            System_Int32_Binding.Register(app);
            ETModel_G2C_RoomDetailInfo_Binding.Register(app);
            ETModel_PlayerComponent_Binding.Register(app);
            ETModel_ComponentWithId_Binding.Register(app);
            Google_Protobuf_Collections_RepeatedField_1_RoomOnePeople_Binding.Register(app);
            System_Collections_Generic_IEnumerator_1_RoomOnePeople_Binding.Register(app);
            System_Collections_Generic_List_1_RoomOnePeople_Binding.Register(app);
            FairyGUI_Controller_Binding.Register(app);
            ETModel_RoomOnePeople_Binding.Register(app);
            ...
            ETModel_TankInfoFirstEnter_Binding.Register(app);
            ETModel_TankFrameInfo_Binding.Register(app);
            ...
            Google_Protobuf_Collections_RepeatedField_1_TankFrameInfo_Binding.Register(app);
            System_Collections_Generic_IEnumerator_1_TankFrameInfo_Binding.Register(app);
            ...
            ETModel_G2C_UserBaseInfo_Binding.Register(app);
