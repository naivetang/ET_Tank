...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_ETVoid_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{};
            method = type.GetMethod("NoAwait", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, NoAwait_0);
        ...
        static StackObject* NoAwait_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            instance_of_this_method.NoAwait();
