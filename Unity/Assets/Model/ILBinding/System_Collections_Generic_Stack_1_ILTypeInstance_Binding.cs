...
{
    unsafe class System_Collections_Generic_Stack_1_ILTypeInstance_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.Stack<ILRuntime.Runtime.Intepreter.ILTypeInstance>);
            args = new Type[]{};
            ...
            app.RegisterCLRMethodRedirection(method, Pop_3);
        ...
        static StackObject* Pop_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
