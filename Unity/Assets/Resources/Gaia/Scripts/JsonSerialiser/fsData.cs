...
namespace Gaia.FullSerializer
{
    ...
    /// types: null, boolean, double, Int64, UInt64, string, Dictionary, or List.
    /// </summary>
    public sealed class fsData {
        /// <summary>
        /// The raw value that this serialized data stores. It can be one of six different types; a
        /// boolean, a double, Int64, UInt64, a string, a Dictionary, or a List.
        /// </summary>
        ...
        /// <summary>
        /// Creates a new fsData instance that holds an unsigned integer.
        /// </summary>
        public fsData(UInt64 i)
        {
            _value = i;
        }
        ...
        public fsDataType Type {
            get {
                ...
                if (_value is UInt64) return fsDataType.UInt64;
        ...
        /// <summary>
        /// Returns true if this fsData instance maps back to an UInt64.
        /// </summary>
        public bool IsUInt64
        {
            get
            {
                return _value is UInt64;
            }
        }
